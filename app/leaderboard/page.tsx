...
import { globalLeaderboard, squadLeaderboard } from '@/lib/mock/leaderboard';
            ...
            <div className="max-w-6xl mx-auto space-y-6">
                ...
                <div className="glass-card p-6">
                    <div className="flex items-end justify-center gap-4 py-4">
                        ...
                        <div className="flex flex-col items-center gap-3">
                            <Avatar initials={top3[1].avatar} size="lg" />
                            <div className="text-center">
                                <p className="text-sm font-semibold text-slate-200">{top3[1].displayName}</p>
                                <p className="text-xs text-slate-500">{getRoleShort(top3[1].role)}</p>
                                <p className="text-base font-black text-slate-300 mt-1 font-mono">{top3[1].avgAIScore}</p>
                            </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                            <div className="relative">
                                <Avatar initials={top3[0].avatar} size="xl" className="ring-2 ring-amber-500/50 shadow-[0_0_30px_rgba(245,158,11,0.4)]" />
                                <div className="absolute -top-2 left-1/2 -translate-x-1/2 text-lg">👑</div>
                            </div>
                            <div className="text-center">
                                <p className="text-base font-bold text-white">{top3[0].displayName}</p>
                                <p className="text-xs text-slate-500">{getRoleShort(top3[0].role)}</p>
                                <p className="text-xl font-black text-emerald-400 mt-1 font-mono">{top3[0].avgAIScore}</p>
                            </div>
                        ...
                        {/* 3rd */}
                        <div className="flex flex-col items-center gap-3">
                            <Avatar initials={top3[2].avatar} size="lg" />
                            <div className="text-center">
                                <p className="text-sm font-semibold text-slate-200">{top3[2].displayName}</p>
                                <p className="text-xs text-slate-500">{getRoleShort(top3[2].role)}</p>
                                <p className="text-base font-black text-amber-600 mt-1 font-mono">{top3[2].avgAIScore}</p>
                            </div>
                ...
                <div className="glass-card p-4 flex items-center gap-4 border-indigo-500/20">
                    ...
                    <div className="text-right">
                        <p className="text-2xl font-black text-white">#{currentUser.globalRank}</p>
